...
- **성과**
  - **RestTemplate 을 사용하여 외부 API와 통신하는 법 터득. Http 통신에 대해 깊이 이해할 수 있었으며 CORS의 개념과 대응방식 학습**
  - **계좌조회 및 저장 로직을 고민하며 동시성, 병렬처리에 대한 고민을 통해 사용자 경험 개선 경험 습득**
  - **금융결제원의 OpenAPI의 명세서를 이용한 개발을 통해 금융 개발에 대해 첫 발을 내딛음**
  - **OpenAI의 ChatGPT API와 Komoran 오픈소스를 사용해 Custom Chatbot을 개발**
